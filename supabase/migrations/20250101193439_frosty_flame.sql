/*
  ...
  1. Changes
    ...
    - Use direct club_id comparison for admin checks
...
DROP POLICY IF EXISTS "admin_view_club_memberships" ON memberships;
DROP POLICY IF EXISTS "admin_manage_club_memberships" ON memberships;
