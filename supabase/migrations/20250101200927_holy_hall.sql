...
DROP POLICY IF EXISTS "maintenance_admin_manage" ON maintenance_schedule;
...
CREATE POLICY "maintenance_schedule_admin_manage"
...
CREATE POLICY "fields_admin_only"
  ON fields
  FOR ALL
  USING (
    EXISTS (
...
CREATE POLICY "club_games_admin_only"
  ON club_games
  FOR ALL
  USING (
    EXISTS (
...
CREATE POLICY "membership_requests_view_admin"
